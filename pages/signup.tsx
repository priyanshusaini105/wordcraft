                    ...
                    <div className="mt-12">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='my-5'>
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-primary" type='text' placeholder="Enter you Name"  {...register("name", {
                                    ...
                                    maxLength: {
                                        value: 28,
                                        message: "Name must be at most 28 characters",
                                    },
                                })} />
                                {errors.name && <span className='text-xs text-error -top-2 '>*{errors.name?.message}</span>}
                            </div>

                            {/* email input */}
                            <div>
                                <div className="text-sm font-bold text-gray-700 tracking-wide">Email Address</div>
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-primary" type='email' placeholder="Enter you Email"  {...register("email", { required: true })} />
                                {errors.email && <span className='text-xs text-error -top-2 '>*{errors.email?.message}</span>}
                            </div>
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex justify-between items-center border-b border-gray-300 focus:border-primary">
                                    <input
                                        className="w-full text-lg py-2 focus:outline-none focus:border-b focus:border-primary"
                                    ...
                                    <div onClick={() => setShowPassword(!showPassword)}>
                                        {showPassword ? <FaRegEyeSlash size={22} color="#64748b" /> : <FaRegEye size={22} color="#64748b" />}
                                    </div>
                                </div>
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex justify-between items-center border-b border-gray-300 focus:border-primary">
                                    <input className="w-full text-lg py-2 focus:border-b focus:outline-none focus:border-primary"
                                    ...
                                    <div onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
                                        {showConfirmPassword ? <FaRegEyeSlash size={22} color="#64748b" /> : <FaRegEye size={22} color="#64748b" />}
                                    </div>
                                </div>
                                {errors.confirm_password && <span className='text-xs text-error -top-2 '>*{errors.confirm_password?.message}</span>}
                            </div>
                            <div className="mt-10">
                                <button className=" flex items-center justify-center gap-5 bg-primary text-gray-100 p-4 w-full rounded-full tracking-wide font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-primary shadow-lg" type='submit'>
