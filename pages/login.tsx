...
const login = () => {
  ...
  return (
    <div className="lg:flex mb-24">
      <Head>
        <title>LogIn-WordCraft | Create & Connect</title>
      </Head>
      <div className="lg:w-1/2 xl:max-w-screen-sm">
        ...
        <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
          <h2 className="text-center text-4xl text-primary font-nunito font-semibold lg:text-left xl:text-5xl
      xl:text-bold ">Log in</h2>
          <div className="mt-12">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mt-10">
                <button className="bg-primary flex items-center justify-center gap-5 text-gray-100 p-4 w-full rounded-full tracking-wide
      ...
      <div className="hidden lg:flex items-center justify-center bg-primary flex-1">
        <div className="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
          <svg className="w-5/6 mx-auto" xmlns="http://www.w3.org/2000/svg" id="f080dbb7-9b2b-439b-a118-60b91c514f72" data-name="Layer 1" viewBox="0 0 528.71721 699.76785">
            ...
            <polygon points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063" fill="#F2A154" />
            ...
            <polygon points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063" fill="#F2A154" />
            <g opacity="0.1">
            ...
            <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z" transform="translate(-335.6414 -100.11607)" fill="#F2A154" />
            ...
            <path d="M820.3586,253.43948l-10.5,10.5s-32,12-47,0c0,0,5.5-11.5,5.5-10.5s-43.5,7.5-47.5,25.5,3,49,3,49-28,132-17,135,114,28,113,9,8-97,8-97l35-67s-5-22-17-29S820.3586,253.43948,820.3586,253.43948Z" transform="translate(-335.6414 -100.11607)" fill="#F2A154" />
            ...
            <path d="M853.8586,298.93948l9,9s6,84-6,101-67,63-70,60-22-18-18-20,57.18287-57.56942,57.18287-57.56942l-4.18287-77.43058Z" transform="translate(-335.6414 -100.11607)" fill="#F2A154" />
